...
import Leaderboard from "@/components/DemoCompetition/Leaderboard";
        ...
        {activeTab === "leaderboard" && (
          <div className="space-y-4">
            <div className="bg-indigo-50 border border-indigo-100 rounded-2xl px-5 py-4 text-sm text-indigo-700">
              <strong>🏆 Compétition du mois</strong> — Classement en direct des meilleurs affiliés.
              Cliquez sur un profil pour voir ses statistiques complètes.
            </div>
            <Leaderboard />
          </div>
        )}
